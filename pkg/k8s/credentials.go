...
import (
	...
	bslices "github.com/konflux-ci/mintmaker/pkg/slices"
)
...
func (k ConfigReader) GetConfig(ctx context.Context) (githubAppIdStr string, appPrivateKeyPem []byte, err error) {
	...
	globalPaCSecretKey := types.NamespacedName{Namespace: MintMakerNamespaceName, Name: PipelinesAsCodeGitHubAppSecretName}
...
func (k *GitCredentialProvider) LookupSecret(ctx context.Context, component *git.ScmComponent, secretType corev1.SecretType) (*corev1.Secret, error) {
	...
	return nil, mmerrors.NewMintMakerError(mmerrors.EComponentGitSecretMissing, nil)
}
