...
func refineGitHostingServiceError(response *http.Response, originErr error) error {
	...
	case 401:
		return mmerrors.NewMintMakerError(mmerrors.EGitLabTokenUnauthorized, originErr)
	case 403:
		return mmerrors.NewMintMakerError(mmerrors.EGitLabTokenInsufficientScope, originErr)
	default:
		return originErr
	}
}
